...
def source_paths():
    ...
    paths += [ROOT/p for p in ["references/LECTURER.md","references/WORKBUDDY-COURSE.md","references/COURSE-CATALOG.md","references/COMMUNICATIONS-SERIES.md","CROSS-PLATFORM.md","MOBILE-WORKFLOW.md","delivery-pack/DELIVERY-WORKFLOW.md","delivery-pack/STYLE-GUIDE-WORD.md","outputs/博AI增效-课程销售矩阵.md","outputs/博AI增效-课程销售客服Q&A.md"]]
