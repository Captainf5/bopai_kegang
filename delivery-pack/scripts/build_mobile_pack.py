...
def source_paths():
    ...
    paths += [ROOT/p for p in ["references/LECTURER.md","references/WORKBUDDY-COURSE.md","CROSS-PLATFORM.md","MOBILE-WORKFLOW.md","delivery-pack/DELIVERY-WORKFLOW.md","delivery-pack/STYLE-GUIDE-WORD.md","outputs/WorkBuddy职场办公实战工作坊-1D.md","outputs/WorkBuddy职场办公实战工作坊-2D.md"]]
    return paths
